...
{
    /// <inheritdoc />
    public partial class FixForumPostKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permissions_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PurchasingInvoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupplierId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasingInvoices", x => x.PurchasingInvoiceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_AdminId_ModuleName",
                table: "Permissions",
                columns: new[] { "AdminId", "ModuleName" },
                unique: true);
